...
class Course(models.Model):
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='course_owner_set', null=True)
    def __str__(self):
...
class Lesson(models.Model):
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='lesson_owner_set', null=True)
    def __str__(self):
        return f"{self.id}, {self.name}, {self.desc}"
...
class Subscription(models.Model):
    """Subscription model"""
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='user_subscriptions', null=True)
